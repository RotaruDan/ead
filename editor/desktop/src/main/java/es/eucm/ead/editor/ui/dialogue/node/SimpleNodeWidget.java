...
public abstract class SimpleNodeWidget<T extends SimpleNode> extends
		NodeWidget<T> {

	public SimpleNodeWidget(T simpleNode, Controller controller,
			Conversation conversation) {
		super(simpleNode, controller, conversation);
	}
}
