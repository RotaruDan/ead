...
public class ConflictResolver implements GoogleApiClient.ConnectionCallbacks,
    ...
    private class HandleConflictTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            DriveApi.DriveContentsResult currentDriveContentsResult = currentFile.open(mGoogleApiClient,
            ...
            DriveApi.DriveContentsResult driveContentsResult = currentDriveContents
