...
public class BrushColorPicker extends IconWithPanelAbove {
	...
	public BrushColorPicker(Skin skin) {
		...
		referenceChild = new IconButton("colorpicker80x80", skin);
		linearLayout.add(referenceChild);
		linearLayout
				.add(new Slider(10, 50, 5, false, skin, "white-horizontal"))
				.expandX();
		panel.setReferenceChild(referenceChild);
		panel.add(linearLayout).colspan(MAX_COLS).expandX().fillX();
		panel.row();
	...
	private void updateColor(Color newColor) {
		...
		referenceChild.getIcon().setColor(newColor);
